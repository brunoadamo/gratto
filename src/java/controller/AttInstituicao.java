 ...
 * @author Bruno
 */
public class AttInstituicao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int id_instituicao = Integer.parseInt(request.getParameter("id"));    
            ...
            i.setIdInstituicao(id_instituicao);
            ...
            if(instituicaoDAO.atualizar(i)) {                
                response.sendRedirect("admin/editInstitution.jsp?id=" + id_instituicao);
            } else{
                response.sendRedirect("admin/editInstitution.jsp?id=" + id_instituicao);   
            }
        }
