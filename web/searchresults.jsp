                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h2 class="section-heading text-uppercase">Resultados de busca</h2>
                            <h3 class="section-subheading text-muted">Resultados encontrados para busca!</h3>
                        </div>
                    </div>
                    <div class="row">
