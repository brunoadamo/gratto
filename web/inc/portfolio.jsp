...
<%--
    Document   : portfolio
    Created on : 27/10/2018, 11:54:09
    Author     : bruno
--%>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 center-block text-center">
                ...
                <a class="portfolio-link btn-warning btn mt-3 btn-xl text-uppercase"  href="/gratto/institutions.jsp">Veja mais <i class="glyphicon glyphicon-plus"></i></a>
