...
<%
    ...
    String navClass = "";
    String port = "/gratto#portfolio";

    if (!pageName.equals("") && !pageName.equals("index.jsp")) {
        navClass = "nav_content";
        port = "/gratto/institutions.jsp";
    }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<%= port%>" >Instituições</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/gratto#about" >Sobre</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/gratto#contact" >Contato</a>
                </li>
                <li class="nav-item">
